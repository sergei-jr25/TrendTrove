    ...
    (() => {
        ...
        function uploadFile(file) {
            if (![ "image/jpeg", "image/png", "image/gif" ].includes(file.type)) {
                ...
                formImage.value = "";
                e.target.closest(".input-item__inner").classList.add("_active");
                return;
            }
        ...
        function rangeInit() {
            const nouslider = document.querySelectorAll(".nouislider");
            console.log(nouslider);
            nouslider.forEach((el => {
                const filterfrom = el.querySelector("[data-from]");
                const filterto = el.querySelector("[data-to]");
                const filterItem = el.querySelector("[data-it]");
                document.getElementById("nouilsider-length");
                const inputs = [ filterfrom, filterto ];
                nouislider.create(filterItem, {
                    start: [ Math.round(Number(filterfrom.value)), Math.round(Number(filterto.value)) ],
                    connect: true,
                    tooltips: [ true, true ],
                    range: {
                        min: [ Math.round(Number(filterfrom.dataset.from)) ],
                        max: [ Math.round(Number(filterto.dataset.to)) ]
                    }
                });
                filterItem.noUiSlider.on("update", (function(values, handler) {
                    inputs[handler].value = values[handler];
                }));
                function setRangeSlider(i, value) {
                    const arr = [ null, null ];
                    arr[i] = value;
                    filterItem.noUiSlider.set(arr);
                }
        ...
        function initSliders() {
            ...
            if (document.querySelector(".trending__slider")) new core(".trending__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".trending__arrow_prev",
                    nextEl: ".trending__arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".product-image__slider")) new core(".product-image__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".product-image__arrow_prev",
                    nextEl: ".product-image__arrow_next"
                }
            });
            if (document.querySelector(".sale__slider")) new core(".sale__slider", {
                ...
                navigation: {
                    prevEl: ".sale__arrow_prev",
                    nextEl: ".sale__arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".card-product-sliders")) {
                const thumbsSwiper = new core(".nav-product-slider__slider", {
                ...
                new core(".body-product-slider__main", {
                    modules: [ Navigation, Thumb ],
                    autoHeight: true,
                    speed: 800,
                    thumbs: {
                    ...
                    navigation: {
                        prevEl: ".body-product-slider__arrow_prev",
                        nextEl: ".body-product-slider__arrow_next"
                    }
                });
            }
            if (document.querySelector(".interested__slider")) new core(".interested__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".comple__slider")) new core(".comple__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: true,
                navigation: {
                    prevEl: ".comple__arrow_prev",
                    nextEl: ".comple__arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".product-login__slider")) new core(".product-login__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                loop: true,
                navigation: {
                    prevEl: ".interested__arrow_prev",
                    nextEl: ".interested__arrow_next"
                },
                on: {}
            });
            if (document.querySelector(".fash-blog__slider")) new core(".fash-blog__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: true,
                pagination: {
                    el: ".fash-blog__pagination",
                    type: "bullets"
                },
                navigation: {
                    nextEl: ".control-catalog__item_arrow-next"
                }
            });
        }
        ...
        document.addEventListener("click", (e => {
            const target = e.target;
            if (menuItems) if (target.closest(".menu__item")) {
                const itemData = target.closest(".menu__item").dataset.itMenu;
                const subMenu = document.querySelector(`[data-sub-menu="${itemData}"]`);
                const itemActive = document.querySelector(".menu__link._active");
                const subMenuActive = document.querySelector(".sub-menu-header__column._active");
                if (subMenu) {
                    target.classList.toggle("_active");
                    subMenu.classList.toggle("_active");
                    if (itemActive) {
                        itemActive.classList.remove("_active");
                        if (subMenuActive) subMenuActive.classList.remove("_active");
                    }
                }
            }
            if (document.querySelector("[data-spoller-button]")) if (target.closest(".oders-login__spoller")) {
                const buttonDate = target.closest(".oders-login__spoller").dataset.spollerButton;
                const content = document.querySelector(`[data-spoller-content="${buttonDate}"]`);
                console.log(content);
                target.classList.toggle("_active");
                content.classList.toggle("_active");
                if (content.classList.contains("_active")) content.style.maxHeight = content.scrollHeight + "px"; else content.style.maxHeight = "";
            }
            if (document.querySelector(".control-catalog")) {
                const controlParrnet = document.querySelector(".catalog__container");
                if (target.closest(".control-catalog__button")) controlParrnet.classList.toggle("_hidden-catlog");
            }
            if (target.closest(".counter")) {
                let value = parseInt(target.closest(".counter__body").querySelector(".counter__input").value);
                console.log(value);
                if (target.closest(".counter__count_minus") && 1 != value) value = --value;
                if (target.closest(".counter__count_plus") && 100 != value) value = ++value;
                target.closest(".counter").querySelector(".counter__input").value = value;
            }
            const inputsPassword = document.querySelectorAll(".input-item__input_password");
            if (target.closest(".input-item__input_password img")) inputsPassword.forEach((input => {
                input.querySelector("input").type = "text";
            }));
            if (target.closest(".sidbar-fash-blog__tags")) {
                e.preventDefault();
                console.log("12345");
                const linkActive = document.querySelector(".sidbar-fash-blog__tag.sidbar-fash-blog__tag_active");
                console.log(linkActive);
                if (linkActive) linkActive.classList.remove("sidbar-fash-blog__tag_active");
                target.closest(".sidbar-fash-blog__tag").classList.add("sidbar-fash-blog__tag_active");
            }
        }));
        window["FLS"] = true;
        isWebp();
